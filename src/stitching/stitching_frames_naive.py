...
while cap.isOpened():
  ...
  # Calculate structural similarity between current frame and previous frame
  if prev_frame is not None:
    ssim = structural_similarity(prev_frame, gray, full=True)[0]
    if ssim > 0.9:  # Adjust the threshold as needed
      continue
