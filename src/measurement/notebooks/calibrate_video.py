...
# Initialize the FisheyeCalibrator
    calibrator = StandardCalibrator(chessboard_size=(3, 3))

    # Add calibration images
    image_files = glob.glob('C:/Users/gbo10/OneDrive/measurement_paper_images/calibration images/new/*.jpg')
    for fname in tqdm(image_files):
        img = cv2.imread(fname)
        success, message, corners = calibrator.add_calib_image(img)
        print(message)
