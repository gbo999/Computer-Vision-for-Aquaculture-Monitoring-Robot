...
df_analysis=pd.read_csv(r'/Users/gilbenor/Documents/code projects/msc/counting_research_algorithms/runs/pose/predict83/length_analysis_new.csv')
...
df_analysis.to_csv('length_analysis_new_split.csv',index=False)
