...
# Read the CSV file
df = pd.read_csv('fifty_one/re (2)/Square20times.csv')
...
plt.suptitle('Square Length Measurement Uncertainty Analysis', fontsize=16)
...
plt.title(f'Square Length Distribution (CV: {cv:.2f}%)')
plt.legend()
plt.tight_layout()

# Save the figure
plt.savefig('fifty_one/figures/square_uncertainty.png')
plt.close()

# Print summary statistics
print("\nSquare Length Measurement Uncertainty Summary:")
print("-" * 50)
