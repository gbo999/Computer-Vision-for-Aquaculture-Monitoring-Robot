...
image_path ='C:/Users/gbo10/OneDrive/research/italy/torino/computer vision/good for test - round/GX010101_13_599.jpg_gamma.jpg'
...
def manual_marking_and_distance(image):
    """
    Allows the user to manually mark two points on an image and calculates the distance between them.

    Parameters:
    image (numpy.ndarray): The input image.

    Returns:
    numpy.ndarray: An array containing the coordinates of the two marked points.
    """
    fig, ax = plt.subplots()
