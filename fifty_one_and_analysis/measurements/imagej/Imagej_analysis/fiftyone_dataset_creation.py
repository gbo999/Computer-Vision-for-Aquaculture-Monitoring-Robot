...
def get_paths(weights_type):
    ...
    prediction_base = f"training and val output/runs/pose/{predict_version}/labels"
    ground_truth_base = "fifty_one_and_analysis/measurements/imagej/other/Giant freshwater prawn carapace keypoint detection.v91i.yolov8/all/labels"
...
def process_measurements(measurement_type, port, weights_type):
    ...
    if measurement_type == 'carapace':
        filtered_data_path = 'fifty_one_and_analysis/measurements/imagej/spreadsheet_files/Filtered_Data.csv'
        ...
        filtered_data_path = 'fifty_one_and_analysis/measurements/imagej/spreadsheet_files/final_full_statistics_with_prawn_ids_and_uncertainty - Copy.xlsx'
    ...
    metadata_path = "fifty_one_and_analysis/measurements/imagej/spreadsheet_files/test images.xlsx"
    
    filtered_df, metadata_df = load_data_fn(filtered_data_path, metadata_path)

    dataset_name = f"prawn_dataset_{measurement_type}_{weights_type}_updated123"
