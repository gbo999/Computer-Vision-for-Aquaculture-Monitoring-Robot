...
pd.options.mode.chained_assignment = None  # default='warn'f
...
# ----- Error Calculation -----
    ...
    df['std_scale'] = df[['Scale_1', 'Scale_2', 'Scale_3']].std(axis=1)
    ...
    df['std_pixels'] = df[['Length_1_pixels', 'Length_2_pixels', 'Length_3_pixels']].std(axis=1)
    ...
    for pond_type in df_outliers['Pond_Type'].unique():
        ...
        #save to csv
        pond_outliers.to_csv(f'fifty_one_and_analysis/measurements/imagej/spreadsheet_files/outliers_{args.type}_{args.weights_type}_{args.error_size}_{pond_type}.csv', index=False)
...
#         # fig.write_html(f"fifty_one_and_analysis/measurements/imagej/results/analysis/model_vs_mean_measurements_{args.type}_{args.weights_type}_{args.error_size}_{pond_type}.html")
...
#             # Save combined plot
#             # combined_fig.write_html(f"fifty_one_and_analysis/measurements/imagej/results/analysis/model_vs_mean_measurements_combined_{args.type}_{args.weights_type}_{args.error_size}.html")
