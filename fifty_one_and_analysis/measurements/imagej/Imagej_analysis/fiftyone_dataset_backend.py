...
"""
FiftyOne dataset creation backend for prawn measurement validation.
...
def process_images(image_paths, prediction_folder_path, ground_truth_paths_text, filtered_df, metadata_df, dataset,pond_type, measurement_type ):
    ...
    if measurement_type == 'carapace':  
        output_file_path = r'fifty_one_and_analysis/measurements/imagej/spreadsheet_files/Updated_carapace_Filtered_Data_with_real_length.xlsx' 
    else:
        output_file_path = r'fifty_one_and_analysis/measurements/imagej/spreadsheet_files/Updated_full_body_Filtered_Data_with_real_length.xlsx' 
