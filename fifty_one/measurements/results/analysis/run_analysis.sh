...
# Get error size
ERROR_OPTIONS=("min" "median" "mean" "max")
display_menu "Select the error size:" "${ERROR_OPTIONS[@]}"
ERROR_SIZE=$(get_user_input "${#ERROR_OPTIONS[@]}")
ERROR_SIZE=${ERROR_OPTIONS[$((ERROR_SIZE-1))]}
echo "Selected error size: $ERROR_SIZE"
echo
