...
class Config:
    ...
    # Image directories
    IMAGE_PATHS = {
        'right': MEASUREMENTS_PATH / "carapace/right",
        'left': MEASUREMENTS_PATH / "carapace/left", 
        'car': MEASUREMENTS_PATH / "carapace/car"
    }
    ...
    METADATA_PATH = BASE_PATH / "fifty_one/measurements/data/test images.xlsx"
