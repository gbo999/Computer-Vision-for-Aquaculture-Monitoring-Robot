...
# Read the CSV file
df = pd.read_csv('fifty_one/re (2)/Total20times.csv')
...
plt.suptitle('Total Length Measurement Uncertainty Analysis', fontsize=16)
...
plt.title(f'Total Length Distribution (CV: {cv:.2f}%)')
plt.legend()
plt.tight_layout()

# Save the figure
plt.savefig('fifty_one/figures/total_uncertainty.png')
plt.close()

# Print summary statistics
print("\nTotal Length Measurement Uncertainty Summary:")
print("-" * 50)
